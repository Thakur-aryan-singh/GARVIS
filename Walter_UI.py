...
"color: rgb(44, 255, 238);")
    ...
    def retranslateUi(self, Garvis):
        _translate = QtCore.QCoreApplication.translate
        Garvis.setWindowTitle(_translate("Garvis", "Desktop Assistant - GARVIS"))  # ✅ Fixed
        self.run_button.setText(_translate("Garvis", "Run"))
        
        self.Time.setHtml(_translate("Garvis", 
                "<html><head><meta name=\"qrichtext\" content=\"1\" /><style type=\"text/css\">\n"
                "p, li { white-space: pre-wrap; }\n"
                "</style></head><body style=\" font-family:'MS Shell Dlg 2'; font-size:24pt;\">\n"
                "<p style=\"font-size:28pt;\"><br /></p></body></html>"))

        self.state_of_assistant.setHtml(_translate("Garvis", 
                "<html><head><meta name=\"qrichtext\" content=\"1\" /><style type=\"text/css\">\n"
                "p, li { white-space: pre-wrap; }\n"
                "</style></head><body style=\" font-family:'MS Shell Dlg 2'; font-size:12pt;\">\n"
                "<p style=\"font-size:12pt;\"><br /></p></body></html>"))

        self.Date.setHtml(_translate("Garvis", 
                "<html><head><meta name=\"qrichtext\" content=\"1\" /><style type=\"text/css\">\n"
                "p, li { white-space: pre-wrap; }\n"
                "</style></head><body style=\" font-family:'MS Shell Dlg 2'; font-size:16pt;\">\n"
                "<p style=\"font-size:17pt;\"><br /></p></body></html>"))

        self.Chat_box.setHtml(_translate("Garvis", 
                "<html><head><meta name=\"qrichtext\" content=\"1\" /><style type=\"text/css\">\n"
                "p, li { white-space: pre-wrap; }\n"
                "</style></head><body style=\" font-family:'MS Shell Dlg 2'; font-size:9pt;\">\n"
                "<p style=\"font-size:11pt;\"><br /></p></body></html>"))

        self.Terminate.setText(_translate("Garvis", "Terminate"))
        
        self.textBrowser.setHtml(_translate("Garvis",  # ✅ Fixed
                "<html><head><meta name=\"qrichtext\" content=\"1\" /><style type=\"text/css\">\n"
                "p, li { white-space: pre-wrap; }\n"
                "</style></head><body style=\" font-family:'Times New Roman'; font-size:30pt; font-weight:600;\">\n"
                "<p align=\"center\" style=\"font-size:36pt;\">G A R V I S</p></body></html>"))

if __name__ == "_main_":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    Garvis = QtWidgets.QMainWindow()
    ui = Ui_Garvis()  # Change this to match the renamed class
    ui.setupUi(Garvis)
    Garvis.show()
    sys.exit(app.exec_())